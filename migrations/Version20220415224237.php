 ...
 */
final class Version20220415224237 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE demande ALTER created_at TYPE TIMESTAMP(0) WITHOUT TIME ZONE');
        $this->addSql('ALTER TABLE demande ALTER created_at DROP DEFAULT');
        $this->addSql('COMMENT ON COLUMN demande.created_at IS NULL');
